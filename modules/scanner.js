// modules/scanner.js - Router scanning operations

import { STORAGE_KEYS } from './constants.js';
import { ROUTERS } from './routers.js';
import { fetchRouterLogs } from './api.js';
import { parseRouterLogs } from './parser.js';
import { tryGetSessionFromCookies } from './storage.js';

export async function scanAllRouters() {
...
export async function scanSingleRouter(routerId) {
	let { [STORAGE_KEYS.SESSION_ID]: sessionId } = await chrome.storage.local.get(STORAGE_KEYS.SESSION_ID);
